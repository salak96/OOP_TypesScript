...
describe('interface',()=> {
    ...
    */
    class Person implements HasName,CanSayHello{
        ...
        constructor(name:string){ //Ini adalah konstruktor dalam kelas Person. Ketika objek Person dibuat, konstruktor ini akan menerima parameter name dan menginisialisasi properti name dengan nilai yang diberikan.
            this.name = name;
        }
